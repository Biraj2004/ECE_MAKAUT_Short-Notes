...
\hline
$\mathrm{O_2}$ & Two unpaired electrons in $\pi^*_{2p}$ & 2 & Paramagnetic \\
\hline
$\mathrm{N_2}$ & Filled bonding orbitals, no antibonding excess & 3 & Diamagnetic \\
\hline
\end{tabularx}
...
\hline
$\mathrm{C=C+XY\rightarrow X-C-C-Y}$ & General addition pattern. \\
\hline
$\mathrm{R-CH_2-CH_2X\rightarrow R-CH=CH_2+HX}$ & General elimination pattern. \\
\hline
$\mathrm{Salicylic\ acid+Acetic\ anhydride\rightarrow Aspirin+Acetic\ acid}$ & Acetylation reaction for aspirin synthesis. \\
\hline
\end{tabularx}
\end{tcolorbox}
