...
% -- Module 2 -----------------------------------------------------------------
\modulestart{2}{Multi-resolution Analysis (MRA) Framework}
...
\begin{center}
  ...
  {\small\color{mydark} DWT \& Multi-resolution Analysis (MRA) $|$ PE-EC703C}
\end{center}
\noindent{\color{myred}\rule{\linewidth}{1.2pt}}
\vspace{4pt}
% ===============================================================================
...
% -- Module 3 -----------------------------------------------------------------
\modulestart{3}{2-Channel Filter Banks and Subband Coding}
...
% -- Module 4 -----------------------------------------------------------------
\modulestart{4}{Bi-orthogonal Wavelets}
...
% -- Module 5 -----------------------------------------------------------------
\modulestart{5}{Transform Coding and Data Compression}
