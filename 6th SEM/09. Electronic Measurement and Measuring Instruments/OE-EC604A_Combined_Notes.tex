...
- \textbf{Analog DAS:} Collects and displays data in continuous analog form (e.g., strip chart recorders, oscilloscope traces).
- \textbf{Digital DAS:} Converts analog signals into digital values for computer storage, display, and processing.
...
$$\text{Wheatstone:} \quad R_x = \frac{Q}{P} R \qquad \text{Kelvin Double:} \quad R = \frac{P}{Q} S \ \left(\text{when} \ \frac{P}{Q} = \frac{p}{q}\right)$$
